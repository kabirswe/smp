    ...
    <section class="main-content">
        ...
        <div class="form-block">
                ...
                <div class="col-md-9">
                    ...
                    <div class="col-md-12">
                        ...
                        <select name="post_category_id" id="post_category_id" class="form-select" onchange="userFormatState('post_category_id')" required>
                            ...
                            @foreach($post_categories as $post_category)
                                <option value="{{ $post_category->id }}" @if($post_category->id == $post->post_category_id) selected @endif >{{ $post_category->name }}</option>
                            @endforeach
                        </select>
                        @if($errors->has('post_category_id'))
                            <div class="error_msg">
                    ...
                    <div class="col-md-12">
                        {!! Form::label('description', 'Description', ['class' => 'form-label']) !!}
                        {!! Form::textarea('description',  $post->description, ['placeholder' => 'Description', 'class' => 'form-control', 'id' => 'description', 'type' => 'textarea']) !!}
                        @if($errors->has('description'))
                            <div class="error_msg">
                                {{ $errors->first('description') }}
                            </div>
                ...
                <div class="col-md-3">
                    <div class="col-md-12">
                        ...
                        {!! Form::text('meta_title', $post->meta_title, ['placeholder' => 'Meta Title', 'class' => 'form-control',  'required' => true]) !!}
                    ...
                    <div class="col-md-12">
                        ...
                        {!! Form::textarea('meta_description', $post->meta_description, ['placeholder' => 'Meta Description', 'class' => 'form-control', 'id' => 'meta_description', 'type' => 'textarea', 'required' => true]) !!}
