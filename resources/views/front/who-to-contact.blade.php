			...
			<div class="container">
				...
				<div class="content-area">
					<div class="content-area-left">
						<img src="{{ asset('images/front/Untitled-design-15.png') }}" alt="">
					</div>
					<div class="content-area-left">
						<div class="accordion" id="accordionExample">
							...
							<div class="accordion-item">
								...
								<div class="accordion-body">
									...
									<a href="#">Sharon@smpnutra.com</a>
									<br>
									or
									<strong>Karen Carrasco</strong><br>	
									<a href="#">Karen@smpnutra.com</a>							
								</div>
								</div>
							</div>
							<div class="accordion-item">
							...
							<div class="accordion-item">
								...
								<div class="accordion-body">
									...
									<a href="#">fulfillment@smpnutra.com</a>
								</div>
								</div>
							</div>
							<div class="accordion-item">
								...
								<div class="accordion-body">
									...
									<a href="#">Zach@smpnutra.com</a><br>
									You can also visit SMSNutra.com for more information on all of our digital marketing services.
								</div>
								</div>
							</div>
							<div class="accordion-item">
